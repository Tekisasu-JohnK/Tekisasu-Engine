...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    with open(
        ...
        source_github_url = f"https://github.com/Tekisasu-JohnK/Tekisasu-Engine/tree/{git_branch}/{source_xml_path}"
        generator_github_url = f"https://github.com/Tekisasu-JohnK/Tekisasu-Engine/tree/{git_branch}/doc/tools/make_rst.py"
